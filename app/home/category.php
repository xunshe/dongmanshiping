                                ...
                                <div class="large-12 columns">
                                        ...
                                        <div class="tabs-panel is-active" id="new-all">
                                         ...
                                         <?php 
                                          $limit = 12;   
                                            ...
                                            $sql2 = "SELECT * FROM movies ORDER BY id DESC limit $start,$limit"; 
                                    ...
                                    <div class="pagination">
                                        <?php
                                         ...
                                         <a href="/dongmanshiping/app/home/category.php?start=<?php echo $pre ?>" class="prev page-numbers">« 上一页</a>
                                        ...
                                        <?php 
                                         if($next < $num_max) { ?>
                                        <a href="/dongmanshiping/app/home/category.php?start=<?php echo $next ?>" class="next page-numbers">下一页 »</a>
                                         <?php  }else{?>
                                    ...
                                    <div class="widgetBox">
                                        ...
                                        <form id="searchform" method="get" action="/dongmanshiping/app/home/search.php" role="search">
                                            <div class="input-group">
                                                <input class="input-group-field" name="keyword" type="text" placeholder="请输入视频标题">
