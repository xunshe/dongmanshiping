<?php 
    ...
    $sql = "SELECT * FROM musics WHERE music_name like '%{$keywords}%'";
?>
                            ...
                            <div class="row secBg">
                                <div class="large-12 columns">
                                    ...
                                    <div class="tabs-content" data-tabs-content="newVideos">
                                        <div class="tabs-panel is-active" id="new-all">
                                         ...
                                         <?php 
                                          $limit = 12;   
                                            ...
                                            $sql = "SELECT * FROM movies  WHERE title like  '%{$keywords}%' ORDER BY id DESC";
                                            ...
                                            $sql2 = "SELECT * FROM movies  WHERE title like  '%{$keywords}%' ORDER BY id DESC limit $start,$limit"; 
                                        ...
                                        <?php }}else{ ?>
                                        <h3 class="text-center" style="margin-top: 50px">抱歉，未搜索到相关内容</h3>
                                        <?php } ?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="pagination">
                                        <?php
                                         ...
                                         <a href="/dongmanshiping/app/home/search.php?&start=<?php echo $pre ?>" class="prev page-numbers">« 上一页</a>
                                        ...
                                        <?php 
                                         if($next < $num_max) { ?>
                                        <a href="/dongmanshiping/app/home/search.php?start=<?php echo $next ?>" class="next page-numbers">下一页 »</a>
                                         <?php  }else{?>
                            ...
                            <div class="row">
                                ...
                                <div class="large-12 medium-7 medium-centered columns">
                                    <div class="widgetBox">
                                        ...
                                        <form id="searchform" method="get" action="search.php" role="search">
