                                ...
                                <div class="row secBg padding-14 removeBorderBottom">
                                    <div class="medium-8 small-8 columns">
                                        <div class="head-title">
                                            ...
                                            <h4><?php echo $category['category_name'] ?>分类下的视频</h4>
                                        </div>
                                    </div>
                            ...
                            <div class="row secBg">
                                <div class="large-12 columns">
                                    ...
                                    <div class="tabs-content" data-tabs-content="newVideos">
                                        <div class="tabs-panel is-active" id="new-all">
                                         ...
                                         <?php 
                                          $limit = 12;   
                                            ...
                                            $sql = "SELECT * FROM movies WHERE category_id='$category_id' ORDER BY id DESC";
                                            ...
                                            $sql2 = "SELECT * FROM movies  WHERE category_id='$category_id' ORDER BY id DESC limit $start,$limit"; 
                                        ...
                                        ?>
                                            <div class="item large-4 medium-6 columns grid-medium end">
                                                <div class="post thumb-border">
                                                    ...
                                                    <div class="post-des">
                                                        <h6><a href="single-video-v2.html"><?php echo $new['title'] ?></a></h6>
                                        ...
                                        <?php }}else{ ?>
										<h3 class="text-center" style="margin-top: 50px">抱歉，当前分类下暂时没有视频</h3>
                                        <?php } ?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="pagination">
                                        <?php
                                         ...
                                         <a href="/dongmanshiping/app/home/list.php?id=<?php echo $id ?>&start=<?php echo $pre ?>" class="prev page-numbers">« 上一页</a>
                                        ...
                                        <?php 
                                         if($next < $num_max) { ?>
                                        <a href="/dongmanshiping/app/home/list.php?id=<?php echo $id ?>&start=<?php echo $next ?>" class="next page-numbers">下一页 »</a>
                                         <?php  }else{?>
                            ...
                            <div class="row">
                                ...
                                <div class="large-12 medium-7 medium-centered columns">
                                    <div class="widgetBox">
                                        ...
                                        <form id="searchform" method="get" role="search" action="/dongmanshiping/app/home/search.php">
                                            <div class="input-group">
                                                <input class="input-group-field" type="text" name="keyword" placeholder="请输入视频标题">
